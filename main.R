...
#A 1:4 Ratio is followed for splitting the data set into test and train sets respectively

#seed function is used to split the data set using the random numbers generated corresponding to the several parameteres included
set.seed(123)
